...
export class AuthenticationService {
  ...
  // Register
  register(name:string, email:string, password:string, password_confirmation:string, endereco: string, bairro: string, cidade: string, uf: string, cep: string, telefone: string){
    const data={
      name:name,
      email:email,
      password:password,
